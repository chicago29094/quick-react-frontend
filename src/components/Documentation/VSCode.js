...
export const VSCode = (props) => {
    ...
    return (
        ...
        <p>Quick-React functionality has been integreated directly into a new Visual Studio Code Extension <code><b>quick-react-code</b></code>.  You can take advantage of using the Quick-React tool directly in VS Code, avoiding the extra step of having to download and install generated React projects in zip archive format from the Quick-React Website.  Simply load Visual Studio Code and search for the extension, <code><b>quick-react-code</b></code>, by using VS Code's integrated <strong>Extension Marketplace</strong> search tool. </p>
